...
- Menú Diario **ya no se vende aparte**: va incluido en Impulso y Premium, y el Básico no lo tiene (decisión 84, 26/09/2026). **Todavía no está construido** y faltan sus reglas —cuántas actualizaciones incluye cada plan, las plantillas iniciales, el restaurante con Menú Diario y sin plan (RN-COM-11 y RN-COM-12)—: no las inventes, pregunta. Hasta entonces el servidor sigue con el servicio de PRD §6.2: 30 actualizaciones (no 25), 229 € + IVA, y los 199 € solo con un plan que conceda la prioridad, que hoy no es ninguno que se pueda contratar.
- Planes: el catálogo de Restavor pasa a ser **solo Básico, Impulso y Premium** (26/09/2026); Bosco manda las fichas una a una. **Básico** (ficha del 26/09/2026, decisión 83, migraciones 145 y 146): 20 € + IVA, NO incluye ningún cambio ni fotografía, arranca a 48 h laborables, va por detrás de Impulso y Premium en la cola (`queue_rank` 0) y recibe el informe **cada trimestre** (`plans.report_period`), con el tráfico de la web. **Impulso+ y Premium+ están archivados** desde el 26/09/2026 (decisión 84, migración 148): no se contratan, no se borran. Hasta que lleguen sus fichas, Impulso y Premium siguen como el 16/09/2026 (decisión 39, migración 96): Impulso 299 € y Premium 499 €, + IVA; Impulso arranca a 48 h laborables y Premium a 24 h. Lo que solo tenía Premium+ —un cambio grande, la prioridad (`plans.grants_priority`), los plazos de realización cortos, la vigilancia de reseñas y el informe completo— **no lo tiene hoy ningún plan contratable**, y no se le pasa a Premium sin que su ficha lo diga.
