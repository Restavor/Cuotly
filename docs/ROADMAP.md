...
|---|---|---|---|
| **H1** | Cimientos técnicos | Repositorio, entornos, base de datos y autenticación funcionando; una persona puede registrarse e iniciar sesión en web y en móvil, sin funcionalidad de negocio todavía | `docs/PLAN-H1-H2.md` |
| **H2** | Identidad multiempresa | Modelo de datos de Espacios/Grupos/Establecimientos, roles básicos y aislamiento entre espacios (RLS) reales; Bosco puede crear el espacio de Restavor, dar de alta un establecimiento e invitar a alguien con un rol, en web y en móvil | `docs/PLAN-H1-H2.md` |
