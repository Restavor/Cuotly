...
export const es = {
  ...
  plansPage: {
    ...
    catalogue: {
      ...
      editingPending:
        "Crear, editar y archivar planes todavía no se hace desde aquí: cómo se versionan el precio y las cuotas está pendiente de decidir. Las condiciones sí se versionan, en Versiones.",
      ...
      editingServicesPending:
        "Crear, editar y archivar servicios todavía no se hace desde aquí, por el mismo motivo que los planes.",
    },
    versions: {
