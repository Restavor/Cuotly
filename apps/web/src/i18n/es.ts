...
export const es = {
  ...
  notifications: {
    ...
    events: {
      ...
      plan_revision_published: "Nueva versión de tu plan o servicio",
  ...
  teamArea: {
    ...
    finance: {
      ...
      // M16 · el resumen del mes, como el dibujo.
      subtitleMonth: "Los cobros del espacio mes a mes: lo cobrado, lo pendiente y lo vencido de lo emitido cada mes.",
      tabSummary: "Resumen",
      tabCharges: "Cobros",
      ...
      cardCollected: "Total cobrado",
      cardPending: "Pendiente de cobro",
      cardOverdue: "Vencido",
      changeVsPrevious: (pct: number) => `${pct > 0 ? "+" : ""}${pct} % vs. mes anterior`,
      noPreviousToCompare: "Sin cobros el mes anterior con los que comparar",
      chargesCount: (n: number) => (n === 1 ? "1 cobro" : `${n} cobros`),
      monthlyTitle: "Cobros mensuales",
      monthlyHint: "Lo cobrado de lo que se emitió cada mes, en los doce meses que acaban en el elegido.",
      monthlyFailed: "No se ha podido leer",
      monthlyBarLabel: (mes: string, importe: string) => `${mes}: ${importe} cobrados`,
      statusTitle: "Estado de cobros",
      statusIssued: (importe: string) => `Emitido en el mes: ${importe}`,
      statusRecurring: (importe: string) => `Ingreso recurrente mensual previsto: ${importe}`,
      monthChargesTitle: "Cobros emitidos en el mes",
      allChargesTitle: "Cobros de los últimos doce meses",
      issuedColumn: "Fecha",
      baseColumn: "Base",
      taxColumn: (pct: number) => `IVA (${pct} %)`,
      taxColumnPlain: "IVA",
      ...
      chargeNotFoundTitle: "Este cobro no existe o no puedes verlo",
      chargeNotFoundReason: "Puede que sea de otro espacio o que ya no tengas acceso a finanzas.",
      periodLine: (desde: string, hasta: string) => `Periodo del ${desde} al ${hasta}`,
      dueLine: (fecha: string) => `Vence el ${fecha}`,
      seeEstablishment: "Ver restaurante",
      planTitle: "Plan contratado",
      planNone: "Este cobro no sale de un plan",
      quoteOrigin: "Sale de un presupuesto",
      seeQuote: "Ver presupuesto",
      detailTitle: "Detalle del cobro",
      detailConcept: "Concepto",
      detailBase: "Importe base",
      detailTax: (pct: number) => `IVA (${pct} %)`,
      detailTotal: "Total",
      detailReceived: "Importe recibido",
      detailOutstanding: "Importe pendiente",
      detailStatus: "Estado",
      receiptsTitle: "Justificante de pago",
      receiptsEmpty: "El restaurante no ha subido ningún justificante de este cobro.",
      receiptFromClient: "Subido por el restaurante",
      receiptFromTeam: "Subido por el equipo",
      receiptUploadedAt: (fecha: string) => `Subido el ${fecha}`,
      receiptReviewNote:
        "Revisa el justificante y registra el pago con el importe que hayas recibido de verdad. Si es todo lo pendiente, el cobro queda pagado; si es menos, queda como pago parcial.",
      nothingToRegister: "Este cobro no tiene nada pendiente: no hay pago que registrar.",
      historyTitle: "Historial de actividad",
      historyIssued: "Cobro emitido",
      historyIssuedDetail: (concepto: string) => `Se emitió "${concepto}".`,
      historyReceiptClient: "El restaurante subió un justificante",
      historyReceiptTeam: "El equipo subió un justificante",
      historyPayment: "Pago registrado",
      historyPaymentDetail: (importe: string, metodo: string) => `${importe} por ${metodo}.`,
      historyReversal: "Pago revertido",
    },
    methods: {
  ...
  panelPlan: {
    ...
    subtitle: "Consulta los detalles de tu plan actual y los servicios contratados.",
    currentTitle: "Tu plan actual",
    active: "Plan activo",
    noName: "Tu plan de mantenimiento",
    noPlanTitle: "No hay ningún plan activo",
    noPlanReason: "Este restaurante no tiene ahora un plan de mantenimiento activo. Si crees que es un error, escribe al equipo.",
    includesTitle: "Incluye cada ciclo:",
    includedLine: (n: number, categoria: string) => `${n} · ${categoria}`,
    usageTitle: "Consumos actuales",
    usageSubtitle: "(ciclo en curso)",
    usageLine: (usados: number, incluidos: number) => `${usados} / ${incluidos}`,
    notIncluded: "No incluido",
    renewalTitle: "Renovación",
    commitmentTitle: "Permanencia",
    commitmentUntil: (fecha: string) => `Hasta el ${fecha}`,
    scheduledTitle: "Cambio de plan programado",
    scheduledLine: (fecha: string) => `Entra en vigor el ${fecha}.`,
    scheduledDirection: { upgrade: "Subida de plan", downgrade: "Bajada de plan", same: "Cambio de plan" },
    // RN-COM-22 a 24 · una versión nueva de lo que tiene contratado.
    revision: {
      title: "Nueva versión de lo que tienes contratado",
      intro: (nombre: string, n: number) => `${nombre} tiene una versión nueva (versión ${n}).`,
      moves: (dia: string) => `Pasarás a ella en tu renovación del ${dia}. Tu permanencia no cambia.`,
      favours: "Solo mejora tus condiciones: no tienes que hacer nada.",
      accepted: "Ya la has aceptado.",
      needsAcceptance:
        "Cambia algo en tu contra, así que necesitamos que la aceptes. Si no la aceptas, sigues con las condiciones que tienes.",
      heldBack:
        "No la has aceptado y sigues con las condiciones que tenías. Si la aceptas, pasarás a ella en tu próxima renovación.",
      onlyOwner: "Solo el propietario del restaurante puede aceptarla.",
    ...
    noPrice: "El precio de tu plan está en tus cobros, en «Pagos y facturas».",

    changeTitle: "Solicitar cambio o baja",
    changeSubtitle: "Puedes pedir un cambio de plan o comunicar la baja de tu servicio. El equipo las revisa todas.",
    tabs: { change: "Solicitar cambio de plan", termination: "Solicitar baja" },
    tabsLabel: "Cambio o baja",
    changeHow:
      "El cambio de plan lo programa el equipo de mantenimiento. Cuéntales a qué plan quieres pasar y desde cuándo, y te responderán en tus mensajes.",
    changeLabel: "¿A qué plan quieres cambiar y desde cuándo?",
    changePlaceholder: "Por ejemplo: quiero pasar a otro plan a partir de la próxima renovación.",
    changeSubmit: "Enviar solicitud de cambio",
    changePending: "Enviando…",
    changeSent: "Enviado. El equipo te responderá en «Mensajes».",
    changeMessagePrefix: "Solicitud de cambio de plan:",
    changeNoConversation: "No hemos podido abrir la conversación con el equipo. Vuelve a intentarlo en un momento.",
    stepsTitle: "Pasos",
    steps: [
      { title: "Cuéntanos qué necesitas", body: "A qué plan quieres pasar y desde cuándo." },
      { title: "El equipo lo revisa", body: "Te responde en tus mensajes con lo que cambia." },
      { title: "Se programa el cambio", body: "Verás aquí el cambio programado y su fecha." },
    ],
    cancel: "Cancelar",
    goToMessages: "Ver mis mensajes",
  },

  // R25 a R27 · "Pagos y facturas" del panel del restaurante.
  panelBilling: {
    subtitle: "Consulta el estado de tus pagos, facturas y presupuestos.",
    pendingTitle: "Pendiente de pago",
    pendingNone: "Nada pendiente",
    pendingCount: (n: number) => (n === 1 ? "1 concepto" : `${n} conceptos`),
    nextDueTitle: "Próximo vencimiento",
    nextDueNone: "Sin vencimientos pendientes",
    lastPaymentTitle: "Último pago realizado",
    lastPaymentNone: "Todavía no hay pagos registrados",
    tabs: { todos: "Todos", pendientes: "Pendientes", revision: "En revisión", pagados: "Pagados" },
    tabsLabel: "Filtrar cobros",
    periods: { "6": "Últimos 6 meses", "12": "Últimos 12 meses", todo: "Todo" },
    periodLabel: "Periodo",
    columnDate: "Vencimiento",
    columnConcept: "Concepto",
    columnPeriod: "Periodo",
    columnBase: "Base",
    columnTax: (pct: number) => `IVA (${pct} %)`,
    columnTotal: "Total",
    columnState: "Estado",
    columnActions: "Acciones",
    groups: { paid: "Pagado", in_review: "Justificante en revisión", pending: "Pendiente" },
    viewDetail: "Ver detalle",
    uploadReceipt: "Subir justificante",
    emptyFilteredTitle: "Ningún cobro con este filtro",
    emptyFilteredReason: "Cambia de pestaña o de periodo para ver el resto.",
    manualNote:
      "Los pagos se registran a mano por el equipo (transferencia o Bizum). Si ya has pagado, sube el justificante para agilizar la comprobación.",
    documentsLink: "Facturas y presupuestos",

    detailTitle: "Detalle del pago",
    detailSubtitle: "Consulta la información del cobro y sube tu justificante.",
    back: "Volver a pagos y facturas",
    dueLabel: (fecha: string) => `Vencimiento: ${fecha}`,
    periodLabelLine: (desde: string, hasta: string) => `Periodo: ${desde} – ${hasta}`,
    baseLabel: "Base imponible",
    taxLabel: (pct: number) => `IVA (${pct} %)`,
    totalLabel: "Total",
    outstandingLabel: "Pendiente de pagar",
    dueDateLabel: "Fecha de vencimiento",
    howTitle: "Cómo realizar el pago",
    ...
    receiptNotConfirm:
      "Enviar un justificante no confirma el pago: el equipo lo revisa y lo registra, y te avisa en la plataforma.",
    receiptNothing: "Este cobro no tiene nada pendiente de pagar.",
    receiptsSent: "Justificantes enviados",
    receiptsNone: "Todavía no has enviado ningún justificante para este cobro.",
    paymentsTitle: "Pagos registrados",
    notFoundTitle: "Ese cobro no está aquí",
    notFoundReason: "O no es de este restaurante o no puedes ver los pagos. Vuelve a la lista.",

    documentsTitle: "Facturas y presupuestos",
  ...
  // R20 · la bandeja de mensajes del restaurante.
  panelMessages: {
    title: "Mensajes",
    subtitle: "Comunícate con el equipo de mantenimiento. Aquí puedes resolver dudas y seguir tus solicitudes.",
    listLabel: "Conversaciones",
    general: "General",
    generalHint: "Consultas y dudas generales",
    requestFallback: "Solicitud",
    noMessages: "Sin mensajes todavía",
    unread: (n: number) => (n === 1 ? "1 sin leer" : `${n} sin leer`),
    lastMessage: (cuando: string) => `Último mensaje: ${cuando}`,
    viewRequest: "Ver solicitud",
    infoTitle: "Información",
    infoGeneral:
      "Es la conversación general con el equipo de mantenimiento. Si lo que cuentas es un cambio, conviértelo en solicitud para que tenga su seguimiento.",
    convert: "Convertir en solicitud",
    requestState: "Estado de la solicitud",
    requestSent: (cuando: string) => `Creada: ${cuando}`,
    requestDetails: "Ver detalles de la solicitud",
    emptyTitle: "Todavía no hay conversaciones",
    emptyReason: "La conversación general aparece al abrir el panel, y cada solicitud trae la suya.",
    notFoundTitle: "Esa conversación no está aquí",
    notFoundReason: "O no es de este restaurante o no tienes acceso a ella. Elige una de la lista.",
  },
  ...
  panelCalendar: {
    ...
    agendaSubtitle: "Consulta el detalle de tus próximos eventos y plazos.",
    views: { mes: "Mes", agenda: "Agenda" },
    viewsLabel: "Vista del calendario",
    all: "Todos",
    kinds: {
      menu: "Menús",
      request: "Solicitudes",
    ...
    kindsSingular: {
      menu: "Publicación de menú",
      request: "Solicitud",
      renewal: "Renovación",
      report: "Informe",
      charge: "Pago",
    },
    kindsLabel: "Tipo de evento",
    previousMonth: "Mes anterior",
    nextMonth: "Mes siguiente",
    today: "Hoy",
    weekdays: ["Lun", "Mar", "Mié", "Jue", "Vie", "Sáb", "Dom"],
    more: (n: number) => `+${n} más`,
    nextEventTitle: "Evento próximo",
    nextEventNone: "No hay nada previsto de hoy en adelante.",
    legendTitle: "Tipos de eventos",
    upcomingTitle: "Próximos eventos",
    upcomingEmpty: "No hay eventos de hoy en adelante con este filtro.",
    detailEmpty: "Elige un evento de la lista para ver su detalle.",
    detailDate: "Fecha",
    detailTime: "Hora",
    detailType: "Tipo",
    detailInfo: "Descripción",
    open: {
      menu: "Ver menú",
      request: "Ver solicitud",
      renewal: "Ver mi plan",
    ...
    menuPublication: (nombre: string) => `Publicación del menú · ${nombre}`,
    ...
    monthEmpty: "Este mes no tiene eventos con este filtro.",
  },
  ...
  panelRequests: {
    ...
    periods: { "30": "Últimos 30 días", "90": "Últimos 90 días", "365": "Último año" },
    filterType: "Tipo de solicitud",
    filterTypeAll: "Todos los tipos",
    unclassified: "A valorar por mantenimiento",
    columnRequest: "Solicitud",
    columnType: "Tipo",
    columnState: "Estado",
    columnSent: "Fecha de envío",
    columnActions: "Acciones",
    view: "Ver solicitud",
    notSent: "Sin enviar",
    count: (n: number) => (n === 1 ? "1 solicitud" : `${n} solicitudes`),
    pageOf: (page: number, pages: number) => `Página ${page} de ${pages}`,
    previous: "Página anterior",
    next: "Página siguiente",
    emptyFilteredTitle: "Ninguna solicitud con estos filtros",
    emptyFilteredReason: "Quita algún filtro para ver el resto.",
    stoppedTitle: "Ahora no se pueden pedir cambios",
    stoppedReason: "El servicio de este restaurante está detenido. El aviso de arriba dice por qué.",
    breadcrumbPanel: "Panel de restaurante",

    // R06
    newTitle: "Nueva solicitud",
    newSubtitle:
      "Cuéntanos qué necesitas. El equipo de mantenimiento revisará tu solicitud y te confirmará la clasificación y, si procede, el presupuesto.",
    restaurantLabel: "Restaurante",
    restaurantHint: "Este es tu restaurante actual.",
    typeLabel: "Tipo de solicitud",
    typeHint: "El equipo de mantenimiento analizará tu solicitud y la clasificará en la categoría correspondiente.",
    descriptionCount: (n: number, max: number) => `${n}/${max}`,
    attachmentsTitle: "Archivos adjuntos",
    attachmentsHint: "Puedes añadir uno ahora y los demás al revisar la solicitud.",
    importantTitle: "Importante",
    importantBody:
      "Tu cuota no se descontará hasta que la solicitud sea aceptada y, en su caso, presupuestada por el equipo de mantenimiento.",
    saveDraft: "Guardar borrador",
    review: "Revisar solicitud",
    creating: "Guardando…",

    // R07
    reviewTitle: "Revisar y enviar solicitud",
    reviewSubtitle:
      "Comprueba que toda la información es correcta antes de enviar tu solicitud al equipo de mantenimiento.",
    draftBadge: "Borrador",
    summaryTitle: "Resumen de la solicitud",
    teamWillReviewTitle: "El equipo de mantenimiento revisará tu solicitud",
    teamWillReviewBody:
      "Tras recibir tu solicitud, el equipo de mantenimiento confirmará su clasificación y, si procede, te enviará un presupuesto. No se aplicará ningún cargo a tu cuota hasta que la solicitud sea aceptada.",
    confirmSend: "Confirmar envío",
    cancel: "Cancelar",
    editContent: "Editar contenido",
    copyTitle: "Copiar borrador a otro restaurante del grupo (opcional)",
    attachFailed:
      "El borrador se ha guardado, pero el archivo no se ha podido adjuntar. Vuelve a añadirlo aquí abajo.",
    recipientLine: (restaurante: string) => `Para ${restaurante} · la atiende el equipo de mantenimiento de tu espacio.`,
    priorityMissing: "Falta la prioridad: sin ella no se puede enviar. Ábrela en «Editar contenido».",
    backToList: "Volver a solicitudes",

    // R08 a R12
    detailSubtitle: "Consulta el estado de tu solicitud y el historial de mensajes.",
    detailSubtitleAccept: "Revisa la propuesta del equipo de mantenimiento.",
    detailSubtitleQuote: "Revisa el presupuesto del equipo de mantenimiento y decide cómo continuar.",
    detailSubtitleResult: "Consulta el estado, el resultado y el historial de esta solicitud.",
    infoTitle: "Información de la solicitud",
    sentLabel: "Fecha de envío",
    priorityLabel: "Prioridad",
    whereLabel: "Dónde está",
    originalTitle: "Solicitud original",
    filesTitle: (n: number) => `Archivos adjuntos (${n})`,
    filesEmpty: "Esta solicitud no tiene archivos adjuntos.",
    trackingTitle: "Estado y seguimiento",
    trackingTitleResult: "Seguimiento de la solicitud",
    noDate: "Sin fecha",
    steps: {
      received: "Solicitud recibida",
      review: "En revisión",
      waiting: "A la espera de tu respuesta",
      accepted: "Aceptada",
      in_progress: "En curso",
      published: "Publicada",
    ...
    waitingInfo: "Necesitamos más información para continuar.",
    waitingAcceptance: "Tienes una propuesta pendiente de aceptar.",
    messagesTitle: "Mensajes",
    askClarification: "Pedir aclaración",
    // R09
    proposalTitle: "Clasificación propuesta",
    proposalUnits: (categoria: string) => `1 · ${categoria}`,
    proposalIncluded: (plan: string) => `Incluido en tu plan ${plan}`,
    proposalIncludedNoName: "Incluido en tu plan",
    proposalNoCost: "(No tiene coste adicional)",
    consumptionTitle: "Consumo de tu plan",
    consumptionUsed: (usados: number, incluidos: number) => `${usados} / ${incluidos} utilizados`,
    consumptionIfAccepted: "Si aceptas esta propuesta:",
    consumptionExhausted: (incluidos: number) =>
      `Ya has usado los ${incluidos} de este ciclo. No podrás aceptarla hasta que se renueve o el equipo te proponga un presupuesto.`,
    consumptionBudgeted: "Tu plan no incluye este tipo de cambio: el equipo te enviará un presupuesto.",
    consumptionUnknown: "No hemos podido leer lo que te queda de este ciclo. Pregúntalo por los mensajes antes de aceptar.",
    extraTitle: "Información adicional",
    extraPlan: "Tu plan actual",
    extraPlanUnknown: "Sin plan activo leído",
    extraIncluded: "Cambios incluidos de este tipo",
    extraIncludedValue: (n: number) => `${n} por ciclo`,
    extraRenews: "El ciclo se renueva",
    includedNote: "Esta propuesta se incluye en tu plan. No se aplicará ningún cargo adicional.",
    // R10
    ...
    webNoUrl: "Este restaurante no tiene la dirección de su web en sus datos, así que no podemos enlazarla.",
    viewPublished: "Ver cambio publicado",
    // R12
    correctionInfo:
  ...
  teamPage: {
    ...
    // M69 a M72 · las cuatro pestañas de Equipo.
    tabsLabel: "Secciones del equipo",
    tabs: {
      miembros: "Miembros y carga",
      permisos: "Permisos",
      invitaciones: "Invitaciones",
      supervision: "Supervisión y disponibilidad",
    },
    members: {
      statMembers: "Miembros del equipo",
      statAdmins: "Administradores",
      statWorkers: "Trabajadores",
      statLoad: "Carga total",
      statLoadHint: "Puntos de los trabajos abiertos del equipo",
      loadNoPermission: "Sin permiso",
      loadNoPermissionHint: "La carga la ve quien asigna trabajos.",
      loadFailed: "No se ha podido calcular",
      points: (n: number) => `${n} ${n === 1 ? "punto" : "puntos"}`,
      memberColumn: "Miembro",
      specialtiesColumn: "Especialidades",
      establishmentsColumn: "Restaurantes autorizados",
      loadColumn: "Carga actual",
      availabilityColumn: "Disponibilidad",
      supervisorColumn: "Supervisor",
      actionsColumn: "Acciones",
      allEstablishments: (n: number) => `Todos (${n})`,
      none: "Ninguno",
      noneFeminine: "Ninguna",
      available: "Disponible",
      unavailable: "No disponible",
      openPermissions: (nombre: string) => `Permisos de ${nombre}`,
    },
    permissions: {
      chooseTitle: "Elige a una persona",
      chooseReason: "Los permisos se ven y se cambian persona a persona.",
      personLabel: "Persona",
      choose: "Ver permisos",
      notFound: "Esa persona no está en este espacio.",
      notMember: "Esa persona no pertenece a este espacio.",
      readOnlyTitle: "El propietario gestiona los roles y permisos.",
      readOnlyReason:
        "Restaurantes y especialidades los cambia quien asigna trabajos; lo que puede hacer un administrador, solo el propietario. Puedes verlos, pero no cambiarlos.",
      ...
      roleHint: "El rol se elige al invitar.",
      supervisorHint: "Se cambia en Supervisión y disponibilidad.",
      accessTitle: "Estado de acceso",
      accessPerformJobs: "Realiza trabajos",
      accessApproveReports: "Aprueba informes",
      accessEstablishments: "Restaurantes autorizados",
      accessSpecialties: "Especialidades",
      yes: "Sí",
      no: "No",
      establishmentsTitle: "Restaurantes autorizados",
      establishmentsIntro:
        "En qué restaurantes puede trabajar (RN-ASG-01). Sin ninguno marcado no recibe trabajos: la autorización nunca se da por defecto.",
      establishmentsByRole:
        "Por su rol gestiona todos los restaurantes del espacio (§4.2): no hace falta marcarlos.",
      noEstablishmentsInSpace: "Todavía no hay restaurantes en el espacio.",
      archived: "archivado",
      ...
      approveReportsHint: "Puede aprobar los informes de los restaurantes antes de enviarlos.",
    ...
    invitations: {
      ...
      roleColumn: "Rol",
      sentColumn: "Fecha de invitación",
      expiresColumn: "Caduca",
      actionsColumn: "Acciones",
      expired: "Caducada",
      ...
      emptyReason: "Cuando invites a alguien, la invitación aparece aquí hasta que la acepte o la canceles.",
      failed: "No se han podido leer las invitaciones.",
      noPermissionTitle: "Sin permiso para invitar",
      noPermissionReason: "Las invitaciones las ve y las gestiona quien puede invitar al equipo.",
    ...
    supervision: {
      ...
      coverageNotice: "La supervisión se asigna a administradores (RN-SUP-01).",
      currentTitle: "Supervisiones vigentes",
      availabilityTitle: "Disponibilidad de miembros",
      availabilityIntro:
        "Cada persona declara si está disponible (RN-ASG-10); las ausencias salen del calendario. No hay horario fijo por persona, así que los fines de semana no se pintan libres.",
      previousWeek: "Semana anterior",
      nextWeek: "Semana siguiente",
      weekOf: (desde: string, hasta: string) => `${desde} – ${hasta}`,
      dayStatus: {
        available: "Disponible",
        absent: "Ausente",
        absence_requested: "Ausencia pedida",
      ...
      noWorkers: "Todavía no hay nadie en el equipo que realice trabajos.",
      absencesTitle: "Ausencias próximas",
      absencesEmpty: "No hay ausencias pedidas ni aprobadas por delante.",
      absencesFailed: "No se han podido leer las ausencias.",
      datesColumn: "Fechas",
      reasonColumn: "Motivo",
      stateColumn: "Estado",
      noReason: "Sin motivo",
      reassignmentsTitle: "Reasignaciones pendientes",
      reassignmentsEmpty: "No hay ninguna reasignación pendiente.",
      reassignmentsFailed: "No se han podido leer las reasignaciones.",
      whatColumn: "Qué",
      dateColumn: "Fecha",
      actionsColumn: "Acciones",
      kindTask: "Tarea",
  ...
  plansPage: {
    ...
    // M21, M54, M55 y M56 · las cuatro pestañas.
    tabsLabel: "Secciones de planes y servicios",
    tabs: {
      planes: "Planes",
      servicios: "Servicios",
      versiones: "Versiones",
      restaurantes: "Asignación y cambio",
    },
    catalogue: {
      loadFailed: "No se ha podido leer todo el catálogo. Lo que falta no se enseña.",
      nameColumn: "Nombre",
      priceColumn: "Precio",
      restaurantsColumn: "Restaurantes",
      actionsColumn: "Acciones",
      view: "Ver",
      pricePerMonth: (precio: string) => `${precio} + IVA/mes`,
      noPlansTitle: "Este espacio no tiene planes",
      noPlansReason: "Los planes se dan de alta con el espacio; todavía no hay ninguno.",
      viewInRestaurants: "Ver en restaurantes",
      perCycle: "por ciclo mensual",
      quotaSmall: (n: number) => `${n} ${n === 1 ? "cambio pequeño" : "cambios pequeños"}`,
      quotaPhoto: (n: number) => `${n} ${n === 1 ? "fotografía" : "fotografías"}`,
      quotaMedium: (n: number) => `${n} ${n === 1 ? "cambio mediano" : "cambios medianos"}`,
      quotaLarge: (n: number) => `${n} ${n === 1 ? "cambio grande" : "cambios grandes"}`,
      nothingIncluded: "No incluye ningún cambio: cualquier modificación se presupuesta aparte (RN-COM-01).",
      rulesTitle: "Lo que decide el plan",
      startSla: "Plazo de inicio",
      hours: (n: number) => `${n} h laborables`,
      executionSla: "Plazo de realización",
      executionSlaValue: (s: number, f: number, m: number, l: number) =>
        `Pequeño ${s} h · Foto ${f} h · Mediano ${m} h · Grande ${l} h`,
      ordering: "Ordena sus propias solicitudes",
      queueRank: "Turno en la cola del equipo",
      queueRankValue: (n: number) => (n === 0 ? "Normal" : `Por delante (nivel ${n})`),
      ...
      conditionsVersion: (n: number, dia: string) => `Versión ${n}, publicada el ${dia}`,
      noConditions: "Sin condiciones publicadas.",
      seeVersions: "Ver versiones",
      editingReadOnly: "Crear, editar y archivar planes es del propietario del espacio (RN-COM-19).",
      archived: "Archivado",
      archivedHint: "No admite altas ni cambios nuevos; quien lo tiene lo conserva (RN-COM-27).",
      revisionLabel: (n: number) => `Versión ${n}`,
      servicesTitle: "Catálogo de servicios adicionales",
      noServicesTitle: "Este espacio no tiene servicios",
      noServicesReason: "Cuando se dé de alta un servicio adicional, aparecerá aquí.",
      kindDailyMenu: "Menú Diario",
      kindOther: "Servicio",
      premiumPrice: (precio: string) => `${precio} + IVA/mes con plan Premium+`,
      premiumPriceHint: "RN-COM-08: con plan Premium+ activo.",
      monthlyUpdates: "Consumo mensual",
      updatesValue: (n: number) => `${n} actualizaciones`,
      ...
      editingServicesReadOnly: "Crear, editar y archivar servicios es del propietario del espacio (RN-COM-19).",
    },
    ...
    edit: {
      ...
      nameLabel: "Nombre",
      priceLabel: "Precio al mes (€, sin IVA)",
      ...
      includedMedium: "Medianos",
      includedLarge: "Grandes",
      startSlaLabel: "Plazo de inicio (horas laborables)",
      executionTitle: "Plazo de realización (horas laborables)",
      ...
      saving: "Guardando…",
      inPlace: "Ningún restaurante lo tiene: el cambio se aplica en el sitio y queda en la auditoría (RN-COM-21).",
      createsVersion: (n: number) =>
        `Lo ${n === 1 ? "tiene 1 restaurante" : `tienen ${n} restaurantes`}: guardar crea una versión nueva. Cada uno pasa en su primera renovación a 30 días o más; lo que le perjudique tendrá que aceptarlo, y si no lo acepta seguirá en la versión que tiene (RN-COM-22 a 24).`,
      renameTitle: "Nombre",
      renameHint: "Corregir el nombre no crea versión (RN-COM-20).",
      rename: "Cambiar nombre",
      archiveTitle: "Archivar",
      archiveHint: "Deja de ofrecerse en altas y cambios nuevos. Quien lo tiene lo conserva. No se borra nada (RN-COM-27).",
      archiveConfirm: "Entiendo que no se podrá contratar ni editar.",
      archiveConfirmMissing: "Marca la casilla para confirmar que quieres archivarlo.",
      archive: "Archivar",
      done: "Guardado.",
      errors: {
    ...
    // RN-COM-22 a 24 y 30 · las versiones del precio y las cuotas.
    revisions: {
      title: "Versiones del precio y las cuotas",
      none: "Tiene una sola versión: todavía no se ha cambiado nada de lo que se contrata.",
      current: "Vigente",
      previous: "Sustituida",
      publishedOn: (dia: string) => `Publicada el ${dia}`,
      compareTitle: (from: number, to: number) => `Qué cambia de la versión ${from} a la ${to}`,
      firstRevision: "Es la primera versión.",
      better: "Mejora para el restaurante",
      worse: "Empeora para el restaurante",
      harmsNote: "Empeora algo: cada restaurante tendrá que aceptarla (RN-COM-23).",
      favoursNote: "Solo mejora: pasa sola en la renovación, sin pedir nada (RN-COM-23).",
      compareFailed: "No se ha podido leer la comparativa.",
      stateTitle: "Dónde está cada restaurante",
      stateNone: "Todos los que lo tienen están en la versión vigente.",
      onRevision: (n: number) => `En la versión ${n}`,
      states: {
        scheduled: (dia: string) => `Pasa el ${dia}`,
        awaiting_acceptance: (dia: string) => `Falta su aceptación · pasaría el ${dia}`,
        held_back: "En versión anterior: no ha aceptado",
      },
      heldBackHint: "Sigue en la versión que aceptó. Decide qué hacer con él (RN-COM-24).",
      fields: {
        price_cents: "Precio",
        ...
        included_large: "Cambios grandes",
        included_updates: "Actualizaciones",
        start_sla_hours: "Plazo de inicio",
        execution_sla_small: "Realización · pequeño",
        execution_sla_photo: "Realización · foto",
        execution_sla_medium: "Realización · mediano",
        execution_sla_large: "Realización · grande",
      ...
      recordTitle: "Registrar aceptación de fuera",
      recordHint: "Si el restaurante aceptó la versión nueva por contrato, regístralo con la fecha y el contrato (RN-COM-23).",
      recordSubmit: "Registrar aceptación",
    },
    versions: {
      subjectLabel: "Plan o servicio",
      choose: "Ver",
      historyTitle: "Historial de versiones",
      current: "Vigente",
      previous: "Anterior",
      detailTitle: "Detalle de la versión",
      versionLabel: "Versión",
      stateLabel: "Estado",
      publishedLabel: "Publicada",
      changesTitle: "Cambios frente a la versión anterior",
      firstVersion: "Es la primera versión: no hay nada con qué compararla.",
      noChanges: "El texto es el mismo, salvo espacios u orden.",
      added: "Añadido",
      removed: "Quitado",
      textTitle: "Texto de esta versión",
      noVersionsTitle: "Sin condiciones publicadas",
      noVersionsReason: "Este plan o servicio todavía no tiene ninguna versión de sus condiciones.",
      subscribersTitle: "Restaurantes con este plan o servicio",
      subscribersNone: "Ningún restaurante lo tiene contratado ahora.",
      acceptanceUnknown: "No se ha podido leer",
      publishNote:
        "Publicar no cambia el precio ni las cuotas: versiona el texto de las condiciones (RN-DAT-07). Cada restaurante conserva la versión que aceptó hasta que acepte la nueva.",
      readOnly: "Publicar versiones es del propietario del espacio.",
    },
    restaurantsTab: {
    ...
    change: {
      title: "Asignación y cambio de plan",
      subtitle: "Gestiona el plan de un restaurante y sus cambios.",
      restaurantLabel: "Restaurante",
      restaurantSubmit: "Ver",
      currentPlan: "Plan actual",
      since: "Desde",
      nextRenewal: "Próxima renovación",
      historyTitle: "Historial de planes",
      historyInitial: "Alta",
      historyChange: "Cambio de plan",
      historyEmpty: "Sin historial de planes.",
      compareTitle: "Comparativa de planes",
      chooseTarget: "Elige el plan al que cambiar",
      newPlan: "Nuevo plan",
      rows: {
        price: "Precio",
        small: "Cambios pequeños",
      ...
      immediateTitle: "Mejora inmediata",
      immediateHint:
        "Se cobra ahora la diferencia por la parte del ciclo que queda y se añaden los consumos proporcionales (RN-COM-15).",
      renewalTitle: "En la próxima renovación",
      renewalHint: (dia: string) => `Se aplicaría el ${dia}, con la bolsa completa del plan nuevo (RN-COM-16, RN-COM-17).`,
      renewalHintNoDate: "Se aplicaría en la próxima renovación, con la bolsa completa del plan nuevo (RN-COM-16, RN-COM-17).",
      commitmentNote: "Al ser un cambio voluntario, empieza una permanencia nueva de 3 meses (RN-COM-05).",
      previewUnavailable: "Sin ciclo abierto no hay nada que prorratear: no se puede mejorar ahora.",
      reviewed: "He revisado la información y los términos del cambio.",
      summaryTitle: "Resumen del cambio",
      summaryFrom: "De",
      summaryTo: "A",
      summaryWhen: "Cuándo",
      summaryNow: "Ahora",
  ...
  settings: {
    ...
    // M23, M57–M64 · lo nuevo de cada pestaña al dejarla como el diseño.
    pageTitle: "Ajustes del espacio",
    pageSubtitle: "Configura la información y las preferencias de tu espacio.",
    // M62 · el registro de auditoría como el diseño.
    auditM62: {
      registerTitle: "Registro de auditoría",
      registerHint:
        "Todas las acciones importantes que se han hecho en el espacio. El registro es inmutable: no se puede editar.",
      filterUser: "Usuario",
      filterAllUsers: "Todos",
      filterAllActions: "Todas",
      exportLabel: "Exportar registro",
      detailColumn: "Detalle",
      detailsSummary: "Ver detalle",
      recordId: "Registro",
      previousValues: "Valores anteriores",
      newValues: "Valores nuevos",
      reasonLabel: "Motivo",
      immutableNote:
        "Este registro no se puede modificar ni eliminar. Conserva el histórico completo de lo que se ha hecho en el espacio.",
      csvHeader: ["Fecha y hora", "Usuario", "Acción", "Elemento", "Identificador", "Cambios", "Motivo"],
      csvFailed: "No se ha podido leer el registro para exportarlo.",
      loadFailed: "No se ha podido leer el registro.",
    },
    view: {
      generalTitle: "Información general",
      ...
      ownershipAction: "Transferir propiedad",
      archiveAction: "Archivar espacio",
      scheduleSummaryTitle: "Horario operativo del espacio",
      scheduleSummaryHint: "El reloj que cuenta los plazos contractuales (RN-CLK-01).",
      seeSchedule: "Ver horarios",
      taxesSummaryTitle: "Impuestos",
      taxesSummaryValue: (n: number) => `${n} % de IVA por defecto`,
      taxesSummaryHint: "Se aplica a los cobros que se emitan a partir de ahora.",
      seeTaxes: "Ver impuestos",
      integrationsSummaryTitle: "Integraciones",
      integrationsSummaryHint: "En cuántos restaurantes está conectada cada fuente.",
      integrationsCount: (conectados: number, total: number) => `${conectados} de ${total}`,
      integrationsFailed: "No se han podido leer las integraciones.",
      configure: "Configurar",
      weekdays: ["Lunes", "Martes", "Miércoles", "Jueves", "Viernes", "Sábado", "Domingo"],
      contractualTitle: "Reloj contractual",
      contractualHint:
        "Cuenta los plazos de inicio y de realización. No se configura: lo fijan las reglas (RN-CLK-01, RN-CLK-02).",
      menuTitle: "Menú Diario",
      menuHint: "Todos los días del año, festivos incluidos (RN-CLK-09).",
      dayColumn: "Día",
      hoursColumn: "Horario",
      stateColumn: "Estado",
      open: "Abierto",
      closed: "Cerrado",
      weeklyTotal: (h: string) => `${h} h laborables a la semana sin festivos (RN-CLK-05).`,
      timezoneTitle: "Zona horaria",
      timezoneShownIn: "Todos los horarios se cuentan en esta zona (RN-CLK-06).",
      holidaysTitle: "Festivos",
      holidaysHint:
        "Un festivo cierra el reloj contractual el día entero (RN-CLK-03). No se editan ni se borran: un cambio no recalcula hacia atrás plazos en curso (RN-CLK-10).",
      holidaysEmpty: "No hay festivos por delante.",
      holidaysFailed: "No se han podido leer los festivos.",
      holidayDate: "Fecha",
      holidayName: "Descripción",
      holidayClosed: "Cerrado todo el día",
      ...
      methodBizum: "Bizum",
      readOnlyValue: "Solo el propietario del espacio lo cambia.",
      sourcesTitle: "Fuentes de datos",
      sourcesHint:
        "Cada fuente se conecta por restaurante (RN-INT-01): lo de uno no se comparte con otro.",
      filterSource: "Fuente",
      filterState: "Estado",
      filterAllSources: "Todas",
      filterAllStates: "Todos",
      filterNotConnected: "Sin conectar",
      filterSubmit: "Filtrar",
      restaurantColumn: "Restaurante",
      notConnected: "Sin conectar",
      noRestaurants: "Todavía no hay restaurantes en el espacio.",
      noMatches: "Ningún restaurante cumple el filtro.",
      restaurantTitle: "Fuentes del restaurante",
      restaurantHint: "Elige un restaurante para ver sus fuentes y configurarlas en su ficha.",
      restaurantLabel: "Restaurante",
      restaurantSubmit: "Ver",
      openRestaurant: "Configurar en su ficha",
      lastSync: "Última sincronización",
      permissionsTitle: "Permisos de acceso",
      twoFactorTitle: "Verificación en dos pasos",
      twoFactorOn: "Activada",
      twoFactorOnHint: "Tu cuenta pide un segundo paso al entrar.",
      twoFactorOff: "Sin activar",
      twoFactorOffHint: "Añade una capa más de seguridad a tu cuenta.",
      twoFactorUnknown: "No se ha podido saber si está activada.",
      configureTwoFactor: "Configurar",
      passwordTitle: "Cambiar contraseña",
      passwordHint: "Actualiza tu contraseña de acceso.",
      newPassword: "Contraseña nueva",
      repeatPassword: "Repite la contraseña",
      passwordSubmit: "Cambiar contraseña",
      passwordPending: "Cambiando…",
      passwordDone: "Contraseña cambiada.",
      sessionsTitle: "Sesiones activas",
      sessionsHint: "Dispositivos con sesión iniciada en tu cuenta.",
      sessionsFailed: "No se han podido leer tus sesiones.",
      accountNote: "Son ajustes de tu cuenta, no del espacio: valen en todos tus espacios.",
      teamNote: "Solo el propietario gestiona invitaciones, roles, permisos y supervisores.",
      eventColumn: "Evento",
      whenTitle: "Configuración general",
      whenTimezone: (zona: string) => `Las horas se cuentan en la zona del espacio: ${zona}.`,
    },
    ...
    fixedRules: [
      ...
      "Ventanas del reloj contractual: de lunes a las 09:00 a sábado a las 14:30, fijadas por RN-CLK-01 y RN-CLK-02.",
    ...
    */
    ...
    auditActions: {
      ...
      "membership.specialties_changed": "Especialidades cambiadas",
      ...
      "subscription.revision_accepted": "Versión nueva aceptada por el restaurante",
      "subscription.revision_recorded": "Aceptación externa de una versión nueva registrada",
      "subscription.revision_applied": "Paso a la versión nueva en la renovación",
      "plan.conditions_published": "Condiciones del plan publicadas",
      "plan.created": "Plan creado",
      "plan.edited": "Plan editado (nadie lo tenía)",
      "plan.revised": "Nueva versión del plan publicada",
      "plan.renamed": "Plan renombrado",
      ...
      "service.edited": "Servicio editado (nadie lo tenía)",
      "service.revised": "Nueva versión del servicio publicada",
      "service.renamed": "Servicio renombrado",
  ...
  reportsPage: {
    ...
    // M18 y M65 a M68 · los paneles del espacio y la biblioteca, en pestañas.
    dashboard: {
      title: "Informes",
      subtitle:
        "Las cifras del espacio mes a mes, calculadas igual que en cada informe, y la biblioteca de informes para los restaurantes.",
      tabs: {
        operacion: "Operación",
        finanzas: "Finanzas",
        digital: "Rendimiento digital",
        generados: "Informes generados",
      },
      monthLabel: "Mes",
      previousMonth: "Mes anterior",
      nextMonth: "Mes siguiente",
      ...
      apply: "Ver",
      failedTitle: "No se han podido calcular las cifras",
      failedReason: "Vuelve a cargar la página. Si sigue igual, avisa a soporte.",
      noPermissionTitle: "No puedes ver los informes del espacio",
      noPermissionReason: "Hace falta el permiso de gestionar clientes. Pídeselo a quien administra el espacio.",
      vsPrevious: (pct: number) => `${pct > 0 ? "+" : ""}${pct} % vs. mes anterior`,
      noPrevious: "Sin mes anterior con el que comparar",
      notApplicable: "Sin trabajos que medir este mes",
      // Operación (M65).
      jobsCompleted: "Trabajos completados",
      requestsReceived: "Solicitudes recibidas",
      averageStart: "Tiempo medio hasta comenzar",
      averageStartHint: "En horas laborables, del reloj contractual.",
      executionCompliance: "Cumplimiento del plazo de realización",
      executionComplianceHint: "Trabajos publicados dentro de su plazo.",
      hours: (h: string) => `${h} h`,
      workloadTitle: "Carga de trabajo por trabajador",
      workloadHint: "Trabajos del mes que lleva cada persona y cuántos publicó dentro del mes. Por nombre, sin ranking.",
      workloadAssigned: "Asignados",
      workloadCompleted: "Publicados",
      workloadEmpty: "Nadie tiene trabajos asignados este mes.",
      delaysTitle: "Trabajos con retraso y bloqueos",
      delaysHint: "Lo que necesita atención ahora mismo, del reloj laborable.",
      delaysEmpty: "Ningún trabajo abierto está fuera de plazo, a punto de vencer ni bloqueado.",
      delayKinds: {
        job_out_of_deadline: "Fuera de plazo",
        job_about_to_expire: "A punto de vencer",
        job_blocked_by_client: "Bloqueado",
      },
      codeColumn: "Trabajo",
      establishmentColumn: "Restaurante",
      stateColumn: "Estado",
      // Finanzas (M66).
      issued: "Emitido en el mes",
      collected: "Cobrado",
      outstanding: "Pendiente de cobro",
      overdueCharges: "Cobros vencidos",
      originTitle: "Mantenimiento recurrente vs. extras",
      originHint: "Lo emitido en el mes según de dónde sale cada cobro.",
      originRecurring: "Planes y servicios (recurrente)",
      originExtras: "Presupuestos (extras)",
      originOther: "Otros cobros",
      byEstablishmentTitle: "Cobros por restaurante",
      byEstablishmentHint: "Lo emitido en el mes en cada restaurante y cómo va su cobro.",
      planColumn: "Plan",
      noPlan: "Sin plan",
      quickTitle: "Acciones rápidas",
      quickCharges: "Ver cobros",
      quickChargesHint: "Finanzas › Cobros",
      quickDue: "Revisar cobros vencidos",
      quickDueHint: "Finanzas › Vencimientos",
      quickQuotes: "Ver presupuestos",
      quickQuotesHint: "Finanzas › Presupuestos",
      // Rendimiento digital (M67).
      sessions: "Sesiones web (GA4)",
      clicks: "Clics en Google (Search Console)",
      connected: "Restaurantes con datos",
      lastSync: "Última sincronización",
      lastSyncNone: "Ninguna todavía",
      digitalTitle: "Rendimiento por restaurante",
      digitalHint:
        "Los datos que han llegado de cada fuente este mes. Cada casilla sin dato dice por qué, y las sesiones de una fuente no se suman con las de otra.",
      seeData: "Ver datos",
      providerOk: "Con datos este mes",
      // Cabeceras cortas de las tablas: las largas de las tarjetas sacaban
      ...
      colClicks: "Clics",
      colLastSync: "Actualizado",
      digitalEmpty: "No hay restaurantes activos en el espacio.",
      providerShort: {
        ga4: "GA4",
  ...
  spaceRequestForm: {
    ...
    phone: "Teléfono",
    phonePlaceholder: "+34 600 000 000",
    estimatedEstablishments: "Número de establecimientos",
    estimatedUsers: "Número de usuarios internos",
    estimateHint: "Aproximado",
    intendedUse: "Uso previsto",
    intendedUsePlaceholder: "Cuéntanos brevemente para qué necesitas el espacio…",
    plan: "Plan",
    /** El precio llega de `CUOTLY_PLAN_TERMS`; aquí solo la unidad. */
    planPriceUnit: "+ IVA/mes",
    planIncludes: {
      pro: (restaurantes: number, personas: number) =>
        `${restaurantes} establecimientos y ${personas} usuarios internos incluidos`,
      agency: "Establecimientos y usuarios internos ilimitados bajo uso razonable",
    },
    ...
    approvedTitle: "Tu solicitud está aprobada",
    approvedBody:
      "Tu espacio ya existe, con 7 días de prueba. La primera mensualidad está emitida: pagarla activa el espacio.",
    rejectedTitle: "Tu solicitud no se ha aprobado",
    rejectedBody: "Puedes enviar otra solicitud cuando quieras.",
    summaryBusiness: "Negocio",
    summaryPlan: "Plan solicitado",
    summaryContact: "Responsable",
    planWithPrice: (plan: string, precio: string) => `${plan} · ${precio} + IVA/mes`,
    ...
    stepNotes: {
      ...
      waiting: "Esperando la información que te hemos pedido.",
      rejected: "No se ha aprobado.",
      trial: "En prueba. Se activa al pagar la primera mensualidad.",
      awaitingPayment: "Archivado hasta que se pague: puedes reactivarlo pagando.",
      archivedByOwner: "Archivado por su propietario.",
      pending: "Pendiente",
    },
    moreInfoHint: "Si necesitamos más información, te la pediremos aquí.",
    viewSubmitted: "Ver datos enviados",
    hideSubmitted: "Ocultar datos enviados",
    submittedDataTitle: "Datos enviados",
  ...
  globalContext: {
    ...
    messages: {
      ...
      tabsLabel: "Lados de la bandeja",
      tabMaintenance: "Mantenimiento",
      tabRestaurants: "Restaurantes",
      /** El selector de contexto: el espacio en una pestaña, el panel en la otra. */
      ...
      emptyFiltered: "Ninguna conversación de esta pestaña cumple la búsqueda o el filtro de arriba.",
      ...
      internal: "Interno",
      noMessagesYet: "Todavía sin mensajes",
      today: (hora: string) => hora,
      /** Cómo se llama cada conversación en la lista. */
      general: "General",
      requestItem: (codigo: string) => `Solicitud · ${codigo}`,
      jobItem: (codigo: string) => `Trabajo · ${codigo}`,
      /** La cabecera de la conversación abierta. */
      headerMaintenance: (espacio: string, restaurante: string) => `${espacio} / ${restaurante}`,
      headerRestaurant: (restaurante: string) => `Panel de ${restaurante} / Equipo de mantenimiento`,
      typeRequest: "Solicitud",
      typeJob: "Conversación interna del trabajo",
      typeEstablishment: "Conversación general del restaurante",
      openRequest: "Abrir solicitud",
      openJob: "Abrir trabajo",
      openEstablishment: "Abrir restaurante",
      openPanel: "Abrir panel",
      sharedNotice: "Conversación compartida con el restaurante.",
      internalNotice: "El restaurante no ve esta conversación.",
      pickTitle: "Elige una conversación",
      pickReason:
        "Ábrela en la lista de la izquierda. Abrirla la marca como leída, por eso no se abre ninguna sola.",
      notFoundTitle: "Esa conversación no está en esta pestaña",
      notFoundReason: "Puede que sea del otro lado, que no cumpla el filtro de arriba o que ya no tengas acceso a ella.",
  ...
  spaceOwnership: {
    ...
    // M64 · "Propiedad, exportación y soporte".
    m64: {
  ...
  cuotlySubscription: {
    ...
    // M60 · la pestaña como el diseño.
    currentPlanTitle: "Tu plan actual",
    pricePerMonth: (precio: string) => `${precio} + IVA/mes`,
    includedSpace: (nombre: string) => `1 espacio (${nombre})`,
    usageOf: (usados: number, limite: number) => `${usados} de ${limite}`,
    usageUnlimited: (usados: number) => `${usados} · sin límite`,
    establishmentsLine: "Restaurantes activos",
    usersLine: "Usuarios internos",
    storageLine: "Almacenamiento",
    storageValue: (usados: string, incluidos: number) => `${usados} de ${incluidos} GB`,
    extrasTitle: "Restaurantes y usuarios adicionales",
    extraEstablishment: "Restaurante adicional",
    extraUser: "Usuario adicional",
    renewalTitle: "Renovación y pago",
    nextRenewal: "Próxima renovación",
    trialEnds: "La prueba termina",
    pendingPaymentTitle: "Pago pendiente",
    pendingPaymentHint:
      "El pago se hace a mano, por transferencia o Bizum con la referencia del cobro. Después, decláralo aquí.",
    nothingPending: "No hay ningún cobro pendiente.",
    historyTitle: "Historial de cobros",
    compareTitle: "Comparar planes",
    features: {
      oneSpace: "1 espacio",
      establishments: (n: number | null) =>
        n === null ? "Restaurantes y usuarios ilimitados" : `${n} restaurantes activos incluidos`,
      users: (n: number | null) => (n === null ? null : `${n} usuarios internos incluidos`),
      storage: (gb: number) => `${gb} GB de almacenamiento`,
    },
    change: {
      toAgency: "Mejorar a Agency",
      toPro: "Programar el paso a Pro",
      pending: "Cambiando…",
      doneAgency: "Plan cambiado a Agency. La diferencia se ha emitido como cobro.",
      donePro: "Paso a Pro programado para la renovación.",
      agencyHint: "El cambio es inmediato y se cobra la parte proporcional del periodo que queda (RN-SUB-10).",
      proHint:
        "Se aplica en la siguiente renovación. Desde que se programa rigen los límites de Pro, así que hay que contratar los adicionales que el uso de hoy necesite (RN-SUB-10).",
      extraEstablishments: "Restaurantes adicionales",
      extraUsers: "Usuarios adicionales",
      trialNoChange: "Durante la prueba no se cambia de plan: se eligió al pedir el espacio (RN-SUB-10).",
      scheduled: (plan: string) => `Paso a ${plan} programado para la renovación.`,
      cancel: "Anular el cambio",
      cancelPending: "Anulando…",
    },
  },
